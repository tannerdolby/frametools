...
/**
 * A lightweight container that accepts strings from user input and displays the
 * reversed strings in a non-editable text area.
 * 
 */
public class ReverseStringDemo extends JPanel implements ActionListener {
	...
	public void actionPerformed(ActionEvent evt) {
		...
		textArea.append(utils.reverse(text, 0, text.length() - 1) + newline);
